...
<body>
	...
	<form action="AuthenticateUser"  onsubmit="return validate()">
		<center>
			<fieldset>
				<div class="Card text-white bg-dark" style="max-width: 30rem;">
					...
					<div class="card-body">
						...
						Customer ID : <label for="text" class="mr-sm-2"></label> <input
							type="text" class="form-control mb-2 mr-sm-2" name="customerId"
							...
							class="form-control mb-2 mr-sm-2" name="customerPassword"
